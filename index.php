...
<head>
    ...
    <title>Minggu 1 - Salman - 119140053</title>
        ...
        <div class="row justify-content-md-center">
            <div class="col-6 border">
                ...
                <form action="" method="post" id="market">
                    ...
                    <div class="row g-3 input-group mb-3" id="inputFormRow">
                        <div class="col">
                        ...
                        <div class="col">
                            <input type="number" name="jumlah" id="jumlah" class="form-control" placeholder="Kuantitas" aria-label="Kuantitas" required>
                        </div>
                    </div>
                    <div id="newrow"></div>
                    <div class="row g-3">
                        <button id="hasil" onclick="tes2()" type="button" class="btn btn-primary">Pesan</button>
                    </div>
                </form>
            </div>
        </div>
